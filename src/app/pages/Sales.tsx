...
const mockData = {
  normal: [
    { month: monthLabels[0], current: 108, previous: 0 },
    { month: monthLabels[1], current: 66, previous: 0 },
    { month: monthLabels[2], current: 118, previous: 0 },
    { month: monthLabels[3], current: 108, previous: 0 },
    { month: monthLabels[4], current: 135, previous: 0 },
    { month: monthLabels[5], current: 145, previous: 0 },
    { month: monthLabels[6], current: 132, previous: 0 },
    { month: monthLabels[7], current: 190, previous: 0 },
    { month: monthLabels[8], current: 155, previous: 0 },
    { month: monthLabels[9], current: 78, previous: 0 },
    { month: monthLabels[10], current: 165, previous: 0 },
    { month: monthLabels[11], current: 142, previous: 0 },
  ],
  pbm: [
    { month: monthLabels[0], current: 66, previous: 106 },
    { month: monthLabels[1], current: 106, previous: 64 },
    { month: monthLabels[2], current: 118, previous: 66 },
    { month: monthLabels[3], current: 113, previous: 107 },
    { month: monthLabels[4], current: 108, previous: 132 },
    { month: monthLabels[5], current: 140, previous: 106 },
    { month: monthLabels[6], current: 147, previous: 96 },
    { month: monthLabels[7], current: 136, previous: 88 },
    { month: monthLabels[8], current: 190, previous: 66 },
    { month: monthLabels[9], current: 155, previous: 78 },
    { month: monthLabels[10], current: 128, previous: 92 },
    { month: monthLabels[11], current: 145, previous: 105 },
  ],
  anual: [
    { month: monthLabels[0], current: 100, previous: 230 },
    { month: monthLabels[1], current: 108, previous: 321 },
    { month: monthLabels[2], current: 200, previous: 66 },
    { month: monthLabels[3], current: 205, previous: 66 },
    { month: monthLabels[4], current: 110, previous: 260 },
    { month: monthLabels[5], current: 105, previous: 235 },
    { month: monthLabels[6], current: 125, previous: 245 },
    { month: monthLabels[7], current: 132, previous: 190 },
    { month: monthLabels[8], current: 180, previous: 117 },
    { month: monthLabels[9], current: 155, previous: 66 },
    { month: monthLabels[10], current: 170, previous: 280 },
    { month: monthLabels[11], current: 138, previous: 195 },
  ],
};
